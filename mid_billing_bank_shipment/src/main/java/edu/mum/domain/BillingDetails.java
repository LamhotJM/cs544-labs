 ...
 * <p>
 * A BillingDetails object is always associated with a single User and depends
 * on the lifecycle of that user. It represents one of the billing strategies
 * the User has choosen, usually one BillingDetails is the default in a
 * collection of many.
 *
...
public abstract class BillingDetails implements Serializable, Comparable {
	...
	public boolean equals(Object o) {
		...
		if (!(created.getTime() == billingDetails.created.getTime()))
			return false;
	...
	public int compareTo(Object o) {
		if (o instanceof BillingDetails)
			...
			return Long.valueOf(this.getCreated().getTime())
					.compareTo(Long.valueOf(((BillingDetails) o).getCreated().getTime()));
		return 0;
	}
