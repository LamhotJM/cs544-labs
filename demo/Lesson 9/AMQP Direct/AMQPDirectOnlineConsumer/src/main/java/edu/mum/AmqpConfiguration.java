...
import edu.mum.amqp.DirectOnlineListener;
...
/*
	   <!--  ****************  ANSWER CONSUMER ************************* -->
	    <rabbit:listener-container connection-factory="connectionFactory">
	   	<rabbit:listener ref="queueListener" method="listen" queue-names="orderOnlineQueue" />
	   </rabbit:listener-container>

	   <bean id="queueListener" class="edu.mum.amqp.DirectOnlineListener" />
...
*/		   
		   ...
		   public SimpleMessageListenerContainer directListenerContainer() {
		       ...
		       container.setQueueNames("orderOnlineQueue");
		       container.setMessageListener(new MessageListenerAdapter(queueListener(),"listen"));
		       return container;
		   }
		   
		   @Bean
		   DirectOnlineListener queueListener() {
			   return new DirectOnlineListener();
		   }
